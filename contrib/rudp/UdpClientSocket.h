...
class UdpClientSocket : boost::noncopyable, public  boost::enable_shared_from_this<UdpClientSocket> {
    public:
        ...
        typedef boost::function<void(Buffer*, Timestamp)> MessageCallback;
        typedef boost::function<void(ConnectResult)> ConnectCallback;
        typedef boost::function<void(DisconnectResutl)> DisconnectCallback;
